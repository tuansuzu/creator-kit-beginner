...
{
    /// <summary>
    /// This define a character in the game. Character is use in a loose sense, as it just mean something that can be
    /// attack and have some stats including health. It can also be an inanimate object like a breakable box.
    /// </summary>
    public class CharacterData : HighlightableObject
    {
        ...
        /// Attack function (doing the actual attack & damage) will be called by an animation event to match the animation
        /// </summary>
