...
{
    /// <summary>
    /// This handle the stats of a CharacterData. It store the health and strength/agility/defense stats.
    /// This class contains various functions to interact with stats, by adding stat modification, elemental effect or
    /// damages.
    /// </summary>
    [System.Serializable]
    public class StatSystem
    {
        ...
        /// is influence by strength & defense stats.
        /// </summary>
        ...
        /// It also contains elemental protections & boost (1 for each elements defined by the DamageType enum)
        /// </summary>
        [System.Serializable]
        public class Stats
        {
        ...
        /// <summary>
        /// Can be added to a stack of modifier on the StatSystem to modify the value of the base stats
        /// e.g. a weapon adding +2 strength will push a modifier on the top of the stack
        ///
        /// They have 2 mode : absolute, where value are added as is, and Percentage, where value are converted to
        ...
        /// <summary>
        /// This is a special StatModifier, that get added to the TimedStatModifier stack, that will be automatically
        /// removed when its duration reach 0. Contains a classic StatModifier that is actual modification.
        /// </summary>
        [System.Serializable]
