...
{
    /// <summary>
    /// This handle the inventory of our character. The inventory is composed of 32 slot maximum, each slot can hold one
    /// TYPE of object, but those can be stacked without limit (e.g. 1 slot used by health potion, but own 20 health potions)
    /// </summary>
    public class InventorySystem
    {
        ...
        public bool UseItem(InventoryEntry item)
        {
            ...
            //(note "consumed" is a loose sense here, e.g. armor get consumed to be removed from inventory & added to
