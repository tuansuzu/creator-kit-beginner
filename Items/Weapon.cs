...
namespace CreatorKitCode 
{
    ...
    /// can have minimum stats & equipped effect, but also have a list of WeaponAttackEffect that will have their
    ...
    public class Weapon : EquipmentItem
    {
        ...
        public class AttackData
        {
            ...
            /// amount of damage, boost & defense have already been applied.
            /// </summary>
            /// <param name="damageType">The type of damage</param>
