...
{
    /// <summary>
    /// All object than can be highlighted (enemies, interactable object etc.) derive from that class, which take care of
    /// Setting the material parameters for it when it get highlighted. (if the object use another material, it will just
