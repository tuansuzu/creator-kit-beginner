...
namespace CreatorKitCodeInternal 
{
    ...
    /// Manage the pool of UI text & activating, placing & fading them out across time.
    /// </summary>
    public class DamageUI : MonoBehaviour
    {
        ...
        /// the pool and place it properly, then register it as an active text so its position & opacity is updated by
        /// the system.
        /// </summary>
